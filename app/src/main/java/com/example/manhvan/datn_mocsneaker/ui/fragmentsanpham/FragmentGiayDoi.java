...
public class FragmentGiayDoi extends Fragment implements SanPhamXemThemInterface{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_giay_doi,container,false);
    ...
    private void initView(View view) {
        recyclerView=view.findViewById(R.id.frag_giayDoi);
    }
    private void getData(){
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                xemThemSanPham.xemThemSanPham(3);
            }
        }).start();
    }
    ...
    public void onSuccessed() {
        recyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                adapter=new XemThemSanPhamAdapter(getActivity(),R.layout.itemxemthemsanpham, MoXemThemSanPham.lstDoi);
