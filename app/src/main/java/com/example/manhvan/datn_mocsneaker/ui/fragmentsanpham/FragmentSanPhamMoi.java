...
public class FragmentSanPhamMoi extends Fragment implements SanPhamXemThemInterface{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_san_pham_moi,container,false);
        initView(view);
        getData();
        return view;
    }
    private void getData() {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                preSanPhamXemThemTatCa.sanPhamXemThemTatCa(2);
            }
        }).start();
    }

    private void initView(View view) {
        recyclerView=view.findViewById(R.id.frag_giayMoi);
